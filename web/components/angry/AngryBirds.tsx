  ...
  return (
    <>
      <button
        ...
        className="px-6 py-3 bg-gradient-to-br from-red-500 to-pink-500 text-white font-bold rounded-2xl shadow-lg shadow-red-900/20 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200 text-sm"
      >
        Angry Birds
      </button>
      {isOpen && (
        ...
        >
          <div
            className="bg-gradient-to-br from-white to-red-50/30 rounded-3xl shadow-2xl p-6 border border-red-200/50"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl font-bold bg-gradient-to-r from-red-600 to-pink-600 bg-clip-text text-transparent">Angry Birds</h2>
              <button
                onClick={() => setIsOpen(false)}
            ...
            <div className="mb-4">
              <canvas
                ...
                className="border-2 border-red-200 rounded-2xl cursor-crosshair shadow-lg"
            ...
            <div className="flex gap-2">
              <button
                onClick={startGame}
                className="flex-1 px-4 py-3 bg-gradient-to-br from-red-600 to-pink-600 text-white font-bold rounded-2xl hover:from-red-700 hover:to-pink-700 transition-all shadow-lg shadow-red-900/20"
              >
            ...
            <p className="text-xs text-red-700/70 text-center mt-4 font-medium">
